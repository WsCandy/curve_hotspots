...
class Wordpress_Hotspots_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->Wordpress_Hotspots, plugin_dir_url( __FILE__ ) . 'css/wp_hotspots-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->Wordpress_Hotspots, plugin_dir_url( __FILE__ ) . 'js/wp_hotspots-admin.js', array( 'jquery' ), $this->version, false );
